...
//				+ "values(?,?,?,?,TO_DATE('1994-12-31'),?, '010-1231-1231', ?, 12345, '서울특별시 영등포구 양평동1가', sysdate, 0,0, 1)";
//		
//		for(int i=0; i<10; i++) {
//			
//			Connection con = null;
...
//				
//				pstmt.setString(2,  pwencoder.encode("123123123"));
//				
//				if(i<8) {
//					

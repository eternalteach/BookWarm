...
public class CommunityBoardCommentVO {
	...
	public CommunityBoardCommentVO(int comm_no, String user_id, int comm_cmt_no, String comm_cmt_content,
			String comm_cmt_written_time, String comm_cmt_modify_time, String comm_cmt_deleted, 

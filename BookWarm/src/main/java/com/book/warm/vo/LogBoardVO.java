...
public class LogBoardVO { // 占쏙옙占쏙옙占쏙옙占� SQL
	...
	private String write_written_date; // 占쌜쇽옙占쏙옙 write_written_date
	...
	public String getWrite_written_date() {
		return write_written_date;
	}

	public void setWrite_written_date(String write_written_date) {
	...
	public LogBoardVO(int write_no, String user_id, String write_written_date, String iSBN, String write_buy_date,

...
public class BookListVO {
	...
	public BookListVO(String isbn, String book_title, String writer_name, String translator_name, String publisher_name,
			int book_tot_page, Timestamp book_published_date, int book_price, int book_price_for_sale,
			String book_stock, String book_story, String book_img, String author, String translator) {
		super();
		this.isbn = isbn;
		this.book_title = book_title;
		this.writer_name = writer_name;

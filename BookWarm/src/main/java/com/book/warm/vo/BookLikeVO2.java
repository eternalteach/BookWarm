...
public class BookLikeVO2 {
	...
	public BookLikeVO2(String user_id, String book_like, String isbn, String book_title, String writer_name,
			String translator_name, String publisher_name, int book_tot_page, Timestamp book_published_date,
			int book_price, int book_price_for_sale, String book_stock, String book_story, String book_img) {
		super();
		this.user_id = user_id;
		this.book_like = book_like;
		this.isbn = isbn;

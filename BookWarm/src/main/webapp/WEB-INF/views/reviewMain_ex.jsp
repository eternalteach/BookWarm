                                    ...
                                    <ul class="nav flex-column flex-lg-row" id="mainNav">
                                        ...
                                        <li class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li class="dropdown-submenu">
                                                    <a class="dropdown-item dropdown-toggle" href="#">Login / Register</a>
                                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li><a class="dropdown-item current" href="blog-mini-sidebar.html"><i class="icon-list-2 menu-icon"></i> Blog Small</a></li>
                                ...
                                <div class="v-blog-items-wrap blog-mini">
                                    <ul class="v-blog-items row mini-items clearfix">
                                        ...
                                        <li class="v-blog-item col-sm-12">
                                            <div class="mini-v-blog-item-wrap">
                                                ...
                                                <div class="blog-v-blog-item-info">
                                                    <h3><a href="blog-standard-post.html">Amazing Standard Post</a></h3>
                                                    <div class="v-blog-item-details">By <a href="page-about-me.html">Vertex</a> on November 9, 2018</div>
                                                    <div class="v-blog-item-description">
                                                        <p>
                                                            Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                                            Etiam aliquam massa quis mauris sollicitudin commodo adipiscing elit.
                                                            Etiam aliquam massa quis mauris adipiscing...
                                                        </p>
                                                    </div>
                                                    <a class="btn v-btn standard white sf-icon-stroke" href="blog-standard-post-2.html" target="_self">
                                                    ...
                                                    <div class="like-info">
                                                        <div class="comments-wrapper">
                                                            <a href="blog-standard-post.html#comment-area">
                                                                <i class="icon-bubble-comment-1"></i><span>5</span>
                                                            </a>
                                                        </div>
                                        ...
                                        <li class="v-blog-item col-sm-12">
                                            <div class="mini-v-blog-item-wrap">
                                                <figure class="animated-overlay overlay-alt">
                                                    <img src="./resources/Vertex/img/blog/02.jpg" />
                                                    <a href="blog-full-width-post.html" class="link-to-post"></a>
                                                    <figcaption>
                                                        <div class="thumb-info thumb-info-v2"><i class="fa fa-angle-right"></i></div>
                                                    </figcaption>
                                                </figure>
                                                <div class="blog-v-blog-item-info">
                                                    <h3><a href="blog-full-width-post.html">Full Width Media Post</a></h3>
                                                    <div class="v-blog-item-details">By <a href="page-about-me.html">Vertex</a> on November 8, 2018</div>
                                                    <div class="v-blog-item-description">
                                                        <p>
                                                            Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                                            Etiam aliquam massa quis mauris sollicitudin commodo
                                                        </p>
                                                    </div>
                                                    <a class="btn v-btn standard white sf-icon-stroke" href="blog-standard-post-2.html" target="_self">
                                                        <i class="icon-arrow-32"></i><span class="text">Read more</span>
                                                    ...
                                                    <div class="like-info">
                                                        <div class="comments-wrapper">
                                                            <a href="blog-full-width-post.html#comment-area">
                                                                <i class="icon-bubble-comment-1"></i><span>1</span>
                                                            </a>
                                                        </div>
                                                        <div class="like-info-wrap">
                                                            <a href="#" class="like-info-inner"><i class="fa fa-heart-o"></i></a>
                                        ...
                                        <li class="v-blog-item col-sm-12">
                                            <div class="mini-v-blog-item-wrap">
                                                <figure class="animated-overlay overlay-alt">
                                                    <img src="./resources/Vertex/img/blog/03.jpg" />
                                                    <a href="blog-quote-post.html" class="link-to-post"></a>
                                                    <figcaption>
                                                        <div class="thumb-info thumb-info-v2"><i class="fa fa-angle-right"></i></div>
                                                    </figcaption>
                                                </figure>
                                                <div class="blog-v-blog-item-info">
                                                    <h3><a href="blog-standard-post.html">Nice Blog Post</a></h3>
                                                    <div class="v-blog-item-details">By <a href="page-about-me.html" rel="author">Vertex</a> on November 6, 2018</div>
                                                    <div class="v-blog-item-description">
                                                        <p>
                                                            Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                                            Etiam aliquam massa quis mauris sollicitudin commodo consectetur adipiscing elit.
                                                            Etiam aliquam massa quis mauris adipiscing...
                                                        </p>
                                                    </div>
                                                    <a class="btn v-btn standard white sf-icon-stroke" href="blog-standard-post-2.html" target="_self">
                                                    ...
                                                    <div class="like-info">
                                                        <div class="comments-wrapper">
                                                            <a href="blog-standard-post.html#comment-area">
                                                                <i class="icon-bubble-comment-1"></i><span>50</span>
                                                            </a>
                                                        </div>
                                                        <div class="like-info-wrap">
                                                            <a href="#" class="like-info-inner"><i class="fa fa-heart-o"></i></a>
                                            ...
                                            <div class="mini-v-blog-item-wrap">
                                                <figure class="animated-overlay overlay-alt">
                                                    <div class="flexslider thumb-slider">
                                                        <ul class="slides">
                                                            <li>
                                                                <a href="blog-slideshow-post.html" class="link-to-post">
                                                                    <img src='./resources/Vertex/img/blog/07.jpg' />
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a href="blog-slideshow-post.html" class="link-to-post">
                                                                    <img src='./resources/Vertex/img/blog/06.jpg' />
                                                                </a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                ...
                                                <div class="blog-v-blog-item-info">
                                                    <h3><a href="blog-slideshow-post.html">Amazing Slideshow Post</a></h3>
                                                    <div class="v-blog-item-details">By <a href="page-about-me.html">Vertex</a> on October 22, 2018</div>
                                                    <div class="v-blog-item-description">
                                                        <p>
                                                            Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                                            Etiam aliquam massa quis mauris sollicitudin commodo...
                                                    ...
                                                    <div class="like-info">
                                                        <div class="comments-wrapper">
                                                            <a href="blog-slideshow-post.html#comment-area">
                                                                <i class="icon-bubble-comment-1"></i><span>5</span>
                                                            </a>
                                                        </div>
                                                        <div class="like-info-wrap">
                                        ...
                                        <li class="v-blog-item col-sm-12">
                                            <div class="mini-v-blog-item-wrap">
                                                <figure class="animated-overlay overlay-alt">
                                                    <img src="./resources/Vertex/img/blog/05.jpg" />
                                                    <a href="blog-standard-sidebar.html" class="link-to-post"></a>
                                                    <figcaption>
                                                        <div class="thumb-info thumb-info-v2"><i class="fa fa-angle-right"></i></div>
                                                    </figcaption>
                                                </figure>
                                                <div class="blog-v-blog-item-info">
                                                    <h3><a href="blog-standard-sidebar.html">Perfect Sidebar Post</a></h3>
                                                    <div class="v-blog-item-details">By <a href="page-about-me.html">Vertex</a> on September 15, 2018</div>
                                                    <div class="v-blog-item-description">
                                                        <p>
                                                    ...
                                                    <div class="like-info">
                                                        <div class="comments-wrapper">
                                                            <a href="blog-standard-sidebar.html#comment-area">
                                                                <i class="icon-bubble-comment-1"></i><span>10</span>
                                                            </a>
                                                        </div>
                                                        <div class="like-info-wrap">
                                                            <a href="#" class="like-info-inner"><i class="fa fa-heart-o"></i></a>
                        ...
                        <section class="widget widget_sf_recent_custom_comments clearfix">
                            ...
                            <ul class="recent-comments-list">
                                ...
                                <li class="comment">
                                    <div class="comment-wrap clearfix">
                                        <div class="comment-avatar">
                                            <img src="./resources/Vertex/img/team/t5.png" class="avatar" height="100" width="100" />
                                        </div>
                                        <div class="comment-content">
                                            <div class="comment-body">
                                                <a href="blog-standard-post.html#comments">

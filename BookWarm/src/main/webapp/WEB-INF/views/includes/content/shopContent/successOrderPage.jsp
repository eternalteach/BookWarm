				...
				<div class="container" style="padding-top: 100px;">
					...
					<div class="row">
						...
						<div class="col-md-4">
							...
							<p>받으시는 분 : ${vo.post_name}</p>
							<p>휴대폰 번호 : ${vo.post_phone}</p>
							<p>주소 : (우편번호 : ${vo.post_zipcode}) ${vo.post_addr} ${vo.post_addr_detail}</p><br>
							...
							<p>총 도서 금액 : ${vo.orders_total}</p>
							<p>총 지불 금액 : ${vo.orders_pay_total}</p>
							결제 방법 :<p id="orders_payment">${vo.orders_payment}</p><br>

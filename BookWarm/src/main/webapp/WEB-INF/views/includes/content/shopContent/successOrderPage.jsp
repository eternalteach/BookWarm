			...
			<div class="container" style="padding-top: 50px;">
				...
				<div class="row">
					...
					<div class="col-md-4">
						...
						<div>
							<a href="/warm/shop/shoplist"><button class="btn v-btn standard lightgrey standard">쇼핑 메인페이지</button></a>&nbsp;&nbsp;&nbsp;
							<a href="/warm/orderList"><button class="btn v-btn standard lightgrey standard">내 주문내역</button></a>
						</div><br>

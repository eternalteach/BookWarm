						...
						<div class="counters">
							<div class="progress-label">
								<span>ReadingPage</span>&nbsp; &nbsp;<strong class="primary-color"
									data-to="${readPageNum}" data-plugin-options="{&quot;decimals&quot;: 0}">${readPageNum}</strong>
							</div>
						</div>
						<div class="counters">
							<div class="progress-label">
								<span>TotalPage</span>&nbsp; &nbsp;<strong class="primary-color"
									data-to="${bookTotalPage}" data-plugin-options="{&quot;decimals&quot;: 0}">${bookTotalPage}</strong>
							</div>
						</div>
						<div class="counters">
							<div class="progress-label">
																		...
																		<span class="entry-author-link"> 
																			<span class="vcard author"> 
																				<span class="v-blog-item-details"> 
																					<a href="#" title="Posts by HB-Themes" rel="author">작성자</a>
																				</span>
																			</span>
																		</span>
																	</span> 
																		...
																		<div class="section">
																			<div class="spacer-b15">
																				<input type="text" id="startRead" class="slider-input" value="${startPage}" hidden="hidden"> 
																				 ...
																				 <input type="text" id="bookTotalPage" value="${bookTotalPage}"hidden="hidden">
																			</div>
					<!-- end .spacer -->
																			...
																			<br/>
																				<span>Total &nbsp; p.${startPage} - p.${endPage}</span>
						<!-- end .slider-wrapper -->
																		</div>
				<!-- end section -->
																	</section>

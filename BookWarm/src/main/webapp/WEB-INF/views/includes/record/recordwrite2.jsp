...
<script type="text/javascript">
	jQuery(document).ready(
			function($) {
				...
				$("#endRead")
						.val("p." + $("#slider-range").slider("values", 1));
			...
			<section class="sidebar-widget bordered-sidebar">
				...
				<div class="section">
					<div class="spacer-b15">
						Start Page : <input type="text" id="startRead"
							class="slider-input" value="260"> End Page : <input
							type="text" id="endRead" class="slider-input" value="280">
					</div>

						...
						<div class="row">
							<div class="col-sm-6">
								<img src="./resources/VertexEx/img/logo-white.png" class="d-inline-block"
									style="width: 70px" />
								<p class="mb-none d-inline-block">© Copyright 2018. All
									Rights Reserved.</p>
			...
			<footer class="footer footer-pompis" id="footer-4">
				<div class="main">
					<div class="container">
						<div class="row">
							<div class="col-md-3">
								<img alt="Vertex" src="./resources/VertexEx/img/logo-white.png"
									style="height: 90px; margin-top: -20px;" class="mb-10">

								<p>Class aptent taciti sociosqu ad litora torquent per
									conubia nostra, per inceptos himenaeos. Nulla nunc dui,
									tristique in semper vel, congue sed ligula auctor torquent per
									conubia nostra.</p>
								<p>
							...
							<div class="col-md-3">
								...
								<div class="footer-contact-info">
									<ul class="pl-0">
										...
										<li>
											<p>
												<i class="fa fa-map-marker"></i>1 Liberty St New York, NY
												5006
											</p>
										</li>
										<li>
								...
								<div class="clearfix">
									...
									<div class="spost clearfix">
										...
										<div class="entry-c">
											...
											<ul class="entry-meta">
												<li><i class="ion-ios-chatboxes-outline"></i> 35
													Comments</li>
											</ul>
										</div>
									</div>
									...
									<div class="spost clearfix">
										...
										<div class="entry-c">
											...
											<ul class="entry-meta">
												<li><i class="ion-ios-chatboxes-outline"></i> 24
													Comments</li>
											</ul>
										</div>
									</div>
									...
									<div class="spost clearfix">
										...
										<div class="entry-c">
											...
											<ul class="entry-meta">
												<li><i class="ion-ios-chatboxes-outline"></i> 19
													Comments</li>
											</ul>
										</div>
									</div>
							...
							<div class="col-md-3">
								...
								<ul class="portfolio-grid">
									<li><a href="#" class="grid-image"> <img
											src="./resources/VertexEx/img/thumbs/project-6.jpg"
											alt="Desert Mini Planet">
									</a></li>
									<li><a href="#" class="grid-image"> <img
											src="./resources/VertexEx/img/thumbs/project-5.jpg"
											alt="SAAP">
									</a></li>
									<li><a href="#" class="grid-image"> <img
											src="./resources/VertexEx/img/thumbs/project-4.png"
											alt="Robot Chicken">
									</a></li>
									<li><a href="#" class="grid-image"> <img
											src="./resources/VertexEx/img/thumbs/project-3.jpg"
											alt="Tree">
									</a></li>
									<li><a href="#" class="grid-image"> <img
											src="./resources/VertexEx/img/thumbs/project-2.jpg"
											alt="Space Invaders">
									</a></li>
									<li><a href="#" class="grid-image"> <img
											src="./resources/VertexEx/img/thumbs/project-7.jpg"
											alt="Polar Ice">
									</a></li>
								</ul>

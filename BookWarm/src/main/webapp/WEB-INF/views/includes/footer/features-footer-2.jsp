			...
			<div class="container">
				<div class="row">
					<div class="col-md-4 col-sm-6">
						<section>
							<img alt="Vertex" src="./resources/VertexEx/img/logo-white.png" height="150"
								class="mb-20">

							<p>
								Class aptent taciti sociosqu ad litora torquent <br /> per
								conubia nostra, per inceptos himenaeos. Nulla <br /> nunc dui,
						...
						<section>
							...
							<div class="footer-contact-info">
								<ul class="pl-none">
									...
									<li class="mb-20">
										<p>
											<i class="fa fa-map-marker"></i>795 Folsom Ave,
										</p>
									</li>
									<li>
										<p>
					...
					<div class="col-md-3 col-sm-6">
						<section>
							...
							<ul class="portfolio-grid four-columns">
								...
								<li><a href="#" class="grid-image"> <img
										src="./resources/VertexEx/img/thumbs/project-8.png" alt="Robot Chicken">
								</a></li>
								<li><a href="#" class="grid-image"> <img
										src="./resources/VertexEx/img/thumbs/project-9.png" alt="Tree">
								</a></li>
							</ul>
						</section>
					</div>

                        ...
                        <div class="v-blog-items-wrap blog-standard">
                            ...
                            <ul class="v-blog-items row standard-items clearfix">
                            	...
                            	<li>
                            		...
                            		<!-- 작성 페이지. -->
                            		<form action="/reviewPerBook">
										<table width="500" cellpadding="0" cellspacing="0" border="1" style="background-color:lightgrey">
											<tr>
												<td>번호</td>
												<td>작성자</td>
												<td>내용</td>
											...
											<tr>
												<td>${dto.mId}</td>
												<td>${dto.mWriter}</td>
												<td><a href="contentView?mId=${dto.mId}">${dto.mContent}</a></td>

                  ...
                  <div class="col-md-8 right-side-sidebar v_blog-medium pt-70">
                           ...
                           <div class="v_blog-item-content col-md-7">
                              <div class="v_blog-item-header">
                                 ...
                                 <a href="./resources/VertexEx/blog-post-standard.html" rel="bookmark">
                                    <h2 class="v_blog-item-title" itemprop="name headline">This is a standard post with a image</h2>
                                 </a>
                              </div>
                     ...
                     <article class="v_blog-item">
                        <div class="v_blog-item-inner row">
                           <div class="v_blog-item-media col-md-5">
                              <a href="#">
                                 <img src="./resources/VertexEx/img/blog/x5.jpg" />
                              </a>
                           </div>
                           <div class="v_blog-item-content col-md-7">
                              <div class="v_blog-item-header">
                     ...
                     <article class="v_blog-item">
                        <div class="v_blog-item-inner row">
                           <div class="v_blog-item-media col-md-5">
                              <div class="fluid-width-video-wrapper" style="padding-top:165px">
                                 <iframe itemprop="video" class="" src="https://player.vimeo.com/video/77770080" frameborder="0" title="dd" webkitallowfullscreen="" mozallowfullscreen="" allowfullscreen=""></iframe>
                              </div>
                           </div>
                           <div class="v_blog-item-content col-md-7">
                              <div class="v_blog-item-header">
                                 ...
                                 <a href="./resources/VertexEx/blog-post-standard-2.html" rel="bookmark">
                                    <h2 class="v_blog-item-title" itemprop="name headline">This is a post with an Vimeo Video</h2>
                                 </a>
                              </div>
                     ...
                     <article class="v_blog-item">
                        <div class="v_blog-item-inner row">
                           <div class="v_blog-item-media col-md-5">
                              <video controls="controls" poster="./resources/VertexEx/img/blog/b21.jpg" class="w-100">
